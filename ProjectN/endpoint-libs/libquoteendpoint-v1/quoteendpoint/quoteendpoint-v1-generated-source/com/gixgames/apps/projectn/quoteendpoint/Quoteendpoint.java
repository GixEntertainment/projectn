...
package com.gixgames.apps.projectn.quoteendpoint;
...
public class Quoteendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://banded-nuance-820.appspot.com/_ah/api/";
  ...
  public class GetQuote extends QuoteendpointRequest<com.gixgames.apps.projectn.quoteendpoint.model.Quote> {
    ...
    protected GetQuote(java.lang.Long id) {
      super(Quoteendpoint.this, "GET", REST_PATH, null, com.gixgames.apps.projectn.quoteendpoint.model.Quote.class);
   ...
   *
   * @param content the {@link com.gixgames.apps.projectn.quoteendpoint.model.Quote}
   * @return the request
   */
  public InsertQuote insertQuote(com.gixgames.apps.projectn.quoteendpoint.model.Quote content) throws java.io.IOException {
    InsertQuote result = new InsertQuote(content);
    initialize(result);
    return result;
  }

  public class InsertQuote extends QuoteendpointRequest<com.gixgames.apps.projectn.quoteendpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected InsertQuote(com.gixgames.apps.projectn.quoteendpoint.model.Quote content) {
      super(Quoteendpoint.this, "POST", REST_PATH, content, com.gixgames.apps.projectn.quoteendpoint.model.Quote.class);
    }
  ...
  public class ListQuote extends QuoteendpointRequest<com.gixgames.apps.projectn.quoteendpoint.model.CollectionResponseQuote> {
     ...
     */
    protected ListQuote() {
      super(Quoteendpoint.this, "GET", REST_PATH, null, com.gixgames.apps.projectn.quoteendpoint.model.CollectionResponseQuote.class);
    }
   ...
   * @return the request
   */
  public UpdateQuote updateQuote(com.gixgames.apps.projectn.quoteendpoint.model.Quote content) throws java.io.IOException {
    UpdateQuote result = new UpdateQuote(content);
    initialize(result);
    return result;
  }

  public class UpdateQuote extends QuoteendpointRequest<com.gixgames.apps.projectn.quoteendpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected UpdateQuote(com.gixgames.apps.projectn.quoteendpoint.model.Quote content) {
      super(Quoteendpoint.this, "PUT", REST_PATH, content, com.gixgames.apps.projectn.quoteendpoint.model.Quote.class);
    }
